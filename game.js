...
const CATEGORIES = {
  ...
  '🎭 Celebrities': ['Tilak Varma','Sachin Tendulkar', 'Virat Kohli', 'Rohit Sharma', 'MS Dhoni', 'Jasprit Bumrah', 'Ravindra Jadeja', 'Hardik Pandya', 'KL Rahul', 'Shubman Gill', 'Rishabh Pant', 'Amitabh Bachchan', 'Shah Rukh Khan', 'Salman Khan', 'Aamir Khan', 'Akshay Kumar', 'Hrithik Roshan', 'Ranbir Kapoor', 'Deepika Padukone', 'Alia Bhatt', 'Priyanka Chopra','Kangana Ranaut','Anushka Sharma','Ranveer Singh','Katrina Kaif','Vicky Kaushal','Sara Ali Khan','Rajkummar Rao','Taapsee Pannu','Bhumi Pednekar','Ayushmann Khurrana'],
